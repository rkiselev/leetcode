...
public class TimeBasedKeyValueStore {
     ...
     * <= timestamp. If there are multiple such values, it returns the value associated with the largest timestamp_prev.
    ...
    class TimeMap {
        ...
        public String get(String key, int timestamp) {
            ...
            while(start <= end) {
                ...
                if (list.get(middle).timestamp == timestamp) return list.get(middle).value;
