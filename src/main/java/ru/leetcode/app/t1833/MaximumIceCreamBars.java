...
public class MaximumIceCreamBars {
    ...
    public static void main(String[] args) {
        assertEquals(4, new Solution().maxIceCream(new int[] {1,3,2,4,1}, 7));
        assertEquals(0, new Solution().maxIceCream(new int[] {10,6,8,7,7,8}, 5));
        assertEquals(6, new Solution().maxIceCream(new int[] {1,6,3,1,2,5}, 20));
    }
