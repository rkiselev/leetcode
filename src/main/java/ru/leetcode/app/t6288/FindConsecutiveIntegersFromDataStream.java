...
public class FindConsecutiveIntegersFromDataStream {
     ...
     *
     * DataStream(int value, int k) Initializes the object with an empty integer stream and the two integers value
     * and k.
    ...
    public static void main(String[] args) {
        DataStream o = new DataStream(4, 3);
        assertFalse(o.consec(4));
        assertFalse(o.consec(4));
        assertTrue(o.consec(4));
        assertFalse(o.consec(3));
    }
